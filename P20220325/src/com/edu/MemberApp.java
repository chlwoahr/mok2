...
public class MemberApp {
	...
	public MemberApp() {
		members.add(new SoccerMember(100, "홍길동", "010-1234-4567", "복실", "A"));
		members.add(new BookMember(101, "홍일동", "010-4567-1234", "갈통", "모험실"));
		members.add(new SwimMember(102, "홍이동", "010-7896-1234", "빡통", "B"));
